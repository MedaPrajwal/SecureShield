...
<%
 ...
 String squs = "";
            if (session.getAttribute("squs") != null) {
                squs = session.getAttribute("squs").toString();
                ...
                <div class="row">
                        <center>  
                                  ...
                                  <form action="./verify_security_answer"  method="post">
                                        ...
                                        <table> <tr>
                                                <td> Question:</td> <td>
                                                    <input type="text" name="qus" id="qus" value="<%=squs%>" placeholder="User-ID" required="required" />
                                                </td>
                                            </tr>

                                            <tr>
                                                <td> Answer:</td>  <td>
                                                    <input type="text" name="ans" placeholder="Your Answer" required="required" />
                                                </td>
                                            </tr>
